    ...
    private void performActionCommand(int buttonMode) {
        ...
        if (mRobotType != R.id.robot_type_lejos) {
            if (buttonMode == ACTION_BUTTON_SHORT) {
            	...
            	sendBTCmessage(BTCommunicator.NO_DELAY,BTCommunicator.DO_BEEP, 50, 100);
                sendBTCmessage(200, BTCommunicator.DO_BEEP, 70, 100);
                sendBTCmessage(400, BTCommunicator.DO_BEEP, 50, 100);
                sendBTCmessage(600, BTCommunicator.DO_BEEP, 1000, 100);
                sendBTCmessage(800, BTCommunicator.DO_BEEP, 900, 300);
                sendBTCmessage(1200, BTCommunicator.DO_BEEP, 70, 300);
                sendBTCmessage(1600, BTCommunicator.DO_BEEP, 50, 300);
